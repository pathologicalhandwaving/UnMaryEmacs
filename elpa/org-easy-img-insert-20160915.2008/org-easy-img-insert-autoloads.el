;;; org-easy-img-insert-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
\(fn IMG-LINK IMG-NAME IMG-CAPTION)" t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-easy-img-insert" '("org-easy-img--")))
