...
For Text modes, fundemental mode, you can just insert */+/- as start just like org mode."
  ...
  (let (space)
    (cond
     ...
     (t
      (setq space "[ ]")))
     (let* ((h1 (concat comment-start-skip space "\\* .*"))
            (h2 (concat comment-start-skip space "\\*\\* .*"))
            (h3 (concat comment-start-skip space "\\*\\*\\* .*"))
            (h4 (concat comment-start-skip space "\\*\\*\\*\\* .*"))
            (h5 (concat comment-start-skip space "\\*\\*\\*\\*\\* .*"))
            (h6 (concat comment-start-skip space "\\*\\*\\*\\*\\*\\* .*"))
            (h7 (concat comment-start-skip space "\\*\\*\\*\\*\\*\\*\\* .*"))
            (h8 (concat comment-start-skip space "\\*\\*\\*\\*\\*\\*\\*\\* .*"))
            (plus (concat comment-start-skip space "\\+ .*"))
            (minus (concat comment-start-skip space "\\- .*")))
       ...
       (message "inherit-org-fontify-buffer"))))
