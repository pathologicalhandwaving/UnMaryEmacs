;;; citar-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(with-eval-after-load 'embark (add-to-list 'embark-target-finders 'citar-citation-finder) (add-to-list 'embark-target-finders 'citar-key-finder))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar" '("citar-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar-citeproc" '("citar-citeproc-csl-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar-file" '("citar-file-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar-filenotify" '("citar-filenotify-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar-latex" '("citar-latex-")))
...
Returns a list of all keys from markdown citations in buffer." nil nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar-markdown" '("citar-markdown-")))
...
Complete a citation style for org-cite with preview." nil nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "citar-org" '("citar-")))
