...
If called interactively, enable Parrot mode if ARG is positive,
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "parrot-rotate" '("parrot-rotate-" "pulse-flag")))
